...
<div class="pb-5">
  ...
  <section class="intro my-3">
    <transition name="fade2" appear>
      <div class="container">
        <div class="row">
          <h1 class="section-title display-4 w-100 text-center">Privacy</h1>
        </div>
      </div>
    </transition>
  </section>
...
<p>
    ...
    Your email address may also be used to send business updates or gather feedback.
</p>

<h4>Other services</h4>
<p>      
    <a href="/" class="text-dark-accent">thock.co</a> leverages the following services, which may have their own respective privacy policies:
</p>
